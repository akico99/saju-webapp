...
const CHAPTERS = [
  ...
  },
  {
    ...
    angle: '이 챕터는 "그래프를 보는 눈"을 만들어주는 챕터입니다. 대운 전체를 훑으며 어느 구간이 상승기이고 어느 구간이 신중기인지 큰 그림과 핵심 결론 위주로 서술하세요. 각 대운 시기별 구체적인 선택지·행동전략은 여기서 다루지 말고(그건 16장 몫), 여기서는 "왜 그 시기가 상승/신중 구간인지"의 근거와 전체 흐름의 총평에 집중하세요.',
    targetWords: 6500
  },
  {
    id: 8, title: '재물운',
  ...
  },
  {
    ...
    interpretationRefs: [5],
    angle: '7장에서 이미 대운 전체 흐름과 어느 구간이 상승/신중 구간인지는 설명했습니다. 이 챕터에서는 그 흐름을 다시 설명하지 말고, 대운 구간을 몇 개의 인생 시기(예: 20대, 30대 초반처럼 실제 연령대)로 묶어 그 시기마다 "실제로 어떤 선택을 하면 좋을지" 구체적인 행동전략·의사결정 가이드를 캘린더처럼 제시하세요. "몇 세부터 몇 세까지는 상승기다" 같은 반복 서술 대신, "이 시기엔 이런 결정을 내려도 좋다/피하는 게 좋다"는 실전 조언 중심으로 쓰세요.',
    targetWords: 5500
  },
  {
    id: 17, title: '개운법',
